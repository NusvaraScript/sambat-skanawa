                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-1">
                                            ...
                                            <form action="{{ route('admin.petugas.destroy', ['petugas' => $petugasItem]) }}"
                                                ...
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-sm btn-outline-danger" title="Hapus petugas">
        ...
        <div class="modal-content">
            ...
            <form id="formEditPetugas" method="POST" style="display:none;">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="editNamaPetugas" class="form-label fw-semibold">Nama Petugas <span class="text-danger">*</span></label>
                            <input type="text" name="nama_petugas" id="editNamaPetugas" class="form-control" required maxlength="255">
                        </div>
                        <div class="col-md-6">
                            <label for="editUsernamePetugas" class="form-label fw-semibold">Username <span class="text-danger">*</span></label>
                            <input type="text" name="username" id="editUsernamePetugas" class="form-control" required maxlength="255">
                        </div>
                        <div class="col-md-4">
                            <label for="editLevelPetugas" class="form-label fw-semibold">Level <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="password" name="password" id="editPasswordPetugas" class="form-control" minlength="6" autocomplete="new-password">
                            <div class="form-text">Kosongkan jika tidak ingin mengubah password.</div>
                        </div>
                        <div class="col-md-4">
                            <label for="editPasswordConfirmPetugas" class="form-label fw-semibold">Konfirmasi Password</label>
                            <input type="password" name="password_confirmation" id="editPasswordConfirmPetugas" class="form-control" autocomplete="new-password">
                        </div>
                    </div>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelectorAll('.btn-edit-petugas').forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                .then(function (data) {
                    document.getElementById('editNamaPetugas').value    = data.nama_petugas;
                    document.getElementById('editUsernamePetugas').value = data.username;
