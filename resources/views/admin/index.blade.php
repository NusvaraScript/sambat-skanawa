                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-lg">
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="col-auto">
                                                        ...
                                                        <p class="mb-0 text-muted">
                                                            {{ \Illuminate\Support\Str::limit($pengaduan->isi_laporan, 80) }}
                                                        </p>
                                                    </td>
                                                    <td>
                                                        <span
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="3" class="text-center text-muted py-4">Belum ada data
                                                        pengaduan.</td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                    ...
                                    <div class="recent-message d-flex px-4 py-3">
                                        ...
                                        <div class="name ms-4">
                                            ...
                                            <h6 class="text-muted mb-0">
                                                Menanggapi:
                                                {{ \Illuminate\Support\Str::limit($aktivitas->pengaduan->judul_laporan ?? 'Pengaduan', 36) }}
                                            </h6>
                                            <small
                                                class="text-muted">{{ $aktivitas->created_at?->diffForHumans() }}</small>
                                        </div>
                                    </div>
                                @empty
